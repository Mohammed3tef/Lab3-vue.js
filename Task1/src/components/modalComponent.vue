<template>
  <main>
            ...
            <div class="row g-0">
              <form action="#" class="col-12 w-75 m-auto">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="title" id="title" v-model="post.title" required />
                </div>
                <div class="form-group col-12 my-2">
                  <textarea name="description" id="description" cols="30" rows="10" class="form-control g-0"
                    placeholder="Description" v-model="post.description" required>
                  </textarea>
                </div>
                <div class="form-group-col-12">
                  <label for="editions"> Edition: </label>
                  <select class="form-select" id="editions" name="editions" v-model="post.edition" required>
                    <option :value="edition" v-for="edition in postdata.editions" :key="edition">
                      {{ edition }}
                    </option>
                  </select>
                </div>
                <div class="col-12">
                  ...
                  <div v-for="media in postdata.shareon" :key="media">
                    <input type="checkbox" name="socialmedia" id="socialmedia" :value="media" v-model="post.shareon" />
                    &nbsp; &nbsp; &nbsp; {{ media }}
                  </div>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  ...
                  <br />
                  <input type="checkbox" v-model="post.shareimmediately" true-value="immediatly" false-value="later" />
                </div>
              </form>
            </div>
          </div>
            ...
            <div class="container p-5">
              ...
              <div class="row g-0">
                <div class="col-12" style="white-space: pre">
                  <label>Share On: </label>
                  <ul>
                    <li v-for="media in post.shareon" :key="media">
                      {{ media }}
                    </li>
                  </ul>
                </div>
    ...
    <!-- End Of Modal -->
    <a class="btn btn-primary mx-auto" data-bs-toggle="modal" href="#exampleModalToggle" role="button">Click Me!</a>
  </main>
</template>
